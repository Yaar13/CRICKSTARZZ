...
//worldMatch10.tournamentName = WorldCup
...
//**********************************T20 WORLD CUP ENDS HERE**********************************



//********************CHAMPIONS TROPHY STARTS HERE******************************
...
championTrophy1.Team1Score = 232            //TEAM 1 WINS HERE
championTrophy1.Team2Score = 230
championTrophy1.ballType = BallType.PinkBall



var championTrophy2 : ChampionTrophy = ChampionTrophy()
championTrophy2.matchNumber = 2
championTrophy2.matchType = MatchType.PlayOffs
championTrophy2.Team1 = team2
championTrophy2.Team2 = team3
championTrophy2.oversFormat = OversFormat.FortyOvers
championTrophy2.Team1Score = 354    //TEAM 2 WINS HERE
championTrophy2.Team2Score = 313
championTrophy2.ballType = BallType.PinkBall


var championTrophy3 : ChampionTrophy = ChampionTrophy()
championTrophy3.matchNumber = 3
championTrophy3.matchType = MatchType.PlayOffs
championTrophy3.Team1 = team1
championTrophy3.Team2 = team3
championTrophy3.oversFormat = OversFormat.FortyOvers
championTrophy3.Team1Score = 348      //TEAM 1 WINS HERE
championTrophy3.Team2Score = 347
championTrophy3.ballType = BallType.PinkBall


var championTrophy4 : ChampionTrophy = ChampionTrophy()
championTrophy4.matchNumber = 4
championTrophy4.matchType = MatchType.SemiFinals
championTrophy4.Team1 = team1
championTrophy4.Team2 = team2
championTrophy4.oversFormat = OversFormat.FortyOvers
championTrophy4.Team1Score = 310
championTrophy4.Team2Score = 309       //TEAM 2 WINS HERE
championTrophy4.ballType = BallType.PinkBall


var championTrophy5 : ChampionTrophy = ChampionTrophy()
championTrophy5.matchNumber = 1
championTrophy5.matchType = MatchType.SemiFinals
championTrophy5.Team1 = team3
championTrophy5.Team2 = team2
championTrophy5.oversFormat = OversFormat.FortyOvers
championTrophy5.Team1Score = 209
championTrophy5.Team2Score = 198            //TEAM 3 WINS HERE
championTrophy5.ballType = BallType.PinkBall



var championTrophy6 : ChampionTrophy = ChampionTrophy()
championTrophy6.matchNumber = 6
championTrophy6.matchType = MatchType.Finals
championTrophy6.Team1 = team1
championTrophy6.Team2 = team3
championTrophy6.oversFormat = OversFormat.FortyOvers
championTrophy6.Team1Score = 412     //TEAM 3 WINS HERE
championTrophy6.Team2Score = 414
championTrophy6.ballType = BallType.PinkBall



//***********************************TEAM 3 WINS THE WORLD CUP*******************************************
